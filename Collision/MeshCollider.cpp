...
void MeshCollider::Update(XMMATRIX* worldPos)
{
	invMatWorld = XMMatrixInverse(nullptr, *worldPos);
}

bool MeshCollider::CheckCollisionSphere(const Sphere& sphere, DirectX::XMVECTOR* inter, XMMATRIX* worldPos,DirectX::XMVECTOR* reject)
{
...
bool MeshCollider::CheckCollisionRay(const Ray& ray, float* distance, XMMATRIX* worldPos, DirectX::XMVECTOR* inter)
{
