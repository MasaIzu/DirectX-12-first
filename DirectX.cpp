...
void DirectXCmd::DirectXInitializ(HWND hwnd){
...
void DirectXCmd::Updata123(Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> dsvHeap)
{	
...
ID3D12Device* DirectXCmd::Device()
{
	return device.Get();
}

HRESULT DirectXCmd::Result()
{
	return result;
}

ID3D12GraphicsCommandList* DirectXCmd::CommandList()
{
