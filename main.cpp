...
//デバッグレイヤーをオンに
	...
	Mesh* mesh[10];
	mesh[0] = new Mesh(device, vertices);
	mesh[1] = new Mesh(device, vertices1);
	mesh[2] = new Mesh(device, vertices2);
	mesh[3] = new Mesh(device, vertices3);
	mesh[4] = new Mesh(device, vertices4);
	mesh[5] = new Mesh(device, vertices5);
	mesh[6] = new Mesh(device, vertices6);
	mesh[7] = new Mesh(device, vertices7);
	mesh[8] = new Mesh(device, vertices8);
	mesh[9] = new Mesh(device, vertices9);
